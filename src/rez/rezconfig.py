...
packages_path = [
    os.path.expanduser("~/packages"),           # locally installed pkgs, not yet deployed
    os.path.expanduser("~/.rez/packages/int"),  # internally developed pkgs, deployed
    os.path.expanduser("~/.rez/packages/ext"),  # external (3rd party) pkgs, such as houdini, boost
]
...
release_packages_path = os.path.expanduser("~/.rez/packages/int")
